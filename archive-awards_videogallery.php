            ...
            <?php if ( have_posts() ) : ?>
                ...
                while ( have_posts() ) : the_post(); $post_count++ ?>
                    <article id="post-<?php the_ID(); ?>" <?php if ($post_count % 3 == 0) post_class('gallery-post-last'); else post_class('gallery-post'); ?>>
                        <?php $featuredvideo = get_post_meta(get_the_ID(), 'videogallery_featured', true); ?>
                        <a href="<?php echo get_permalink(); ?>"><img src="<?php echo $featuredvideo['thumbnailurl']; ?>" width="320" height="240" class="gallery-featuredimage " /></a>

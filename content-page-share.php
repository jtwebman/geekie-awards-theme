...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="socialbar">
        ...
        <div class="socialshare twitter-share "><a href="https://twitter.com/share" class="twitter-share-button" data-via="TheGeekieAwards" data-related="Nedopak" data-url="<?php echo get_permalink() ?>" data-lang="en">Tweet</a></div>

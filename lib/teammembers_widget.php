...
class TeamMemberWidget extends WP_Widget
{
  function TeamMemberWidget()
  {
    $widget_ops = array('classname' => 'TeamMemberWidget', 'description' => 'Displays all the team member images.' );
    $this->WP_Widget('TeamMemberWidget', 'Team Member Images', $widget_ops);
  }
 
  function form($instance)
  {
    $defaults = array( 'title' => __('Team Members', 'thegeekieawards'), 'class' => 'teammember-side', 'size' => '90', 'showname' => false );  
...
<?php
  ...
  function widget($args, $instance)
  {
	...
	echo do_shortcode('[team' . $class . $size . $showname .']'); 
...
function register_teammembers_widget() {
	register_widget( 'TeamMemberWidget' ); 
}

add_action( 'widgets_init', 'register_teammembers_widget' );

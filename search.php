    ...
    <div id="content">
        <?php if ( have_posts() ) : ?>
            <header class="archive-header">
                <h1 class="archive-title"><?php printf( __( 'Search Results for: %s', 'thegeekieawards' ), get_search_query() ); ?></h1>
                <hr />
            </header>
            <?php
            /* Start the Loop */
            ...
            while ( have_posts() ) : the_post(); $post_count++; ?>
                <article id="post-<?php the_ID(); ?>" <?php if ($post_count % 2 == 0) post_class('category-post-last'); else post_class('category-post'); ?>>

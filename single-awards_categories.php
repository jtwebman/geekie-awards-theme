<?php
/**
 * The Template for displaying all single awards category page.
 *
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	          ...
	          <div class="entry-content">
							<p style="text-align: center;">
								<?php echo get_the_post_thumbnail(get_the_id(), 'category-thumbnail', array( 'style' => 'margin-top: 20px; margin-bottom: 20px;' )) ?>
							</p>
							<?php the_content(); ?>
	          </div>
	    	</article>
...
<?php get_sidebar('awards-category'); ?>
<?php get_footer(); ?>
